      ...
      <div class="filter-row">
        <div class="filter-group">
          <div class="filter-with-icon">
            ...
            <input v-model="search" placeholder="Поиск по названию..." class="form-input search-input" />
          </div>
        </div>
        ...
        <div class="filter-group">
          <div class="filter-with-icon">
            ...
            <input v-model="owner" placeholder="Владелец проекта" class="form-input filter-input" />
          </div>
        </div>
        ...
        <div class="filter-group">
          <div class="filter-with-icon">
            <svg class="input-icon" width="16" height="16" viewBox="0 0 24 24" fill="none">
              <path
                d="M3 4H21M6 8H18M8 12H16M10 16H14"
                stroke="currentColor"
                stroke-width="2"
                stroke-linecap="round"
              />
